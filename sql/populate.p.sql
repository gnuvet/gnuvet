...
insert into pay_modes values(1,'Cash',FALSE),(2,'Debit Card',FALSE),(3,'Cheque',TRUE),(4,'Credit Card',TRUE),(5,'Transfer',TRUE),(6,'Direct Debit',TRUE);

insert into ptypes(pt_name)values('med','other','serv','cons','hist','good','food');
...
(1,'Amoxicillin Injectable','amoxi1',1,TRUE,0.12,3,FALSE,1),
(2,'Amoxicillin Injectable 50 ml','amoxib',1,TRUE,5.96,9,TRUE,2),
(3,'Amoxicillin Tablets 50 mg','amoxit50',1,TRUE,0.12,1,TRUE,2),
(4,'Amoxicillin Tablets 100 mg','amoxit100',1,TRUE,0.22,1,TRUE,2),
(5,'Amoxicillin Tablets 250 mg','amoxit250',1,TRUE,0.43,1,TRUE,2),
(6,'Antirobe Capsules 25 mg','antir25',1,TRUE,0.60,1,TRUE,2),
(7,'Antirobe Capsules 75 mg','antir75',1,TRUE,1.70,1,TRUE,2),
(8,'Antirobe Capsules 150 mg','antir150',1,TRUE,3.23,1,TRUE,2),
(9,'Antirobe Capsules 300 mg','antir300',1,TRUE,6.30,1,TRUE,2),
(10,'Baytril Injectable 2.5 %','baytri2.5',1,TRUE,0.49,3,FALSE,1),
(11,'Baytril Injectable 5 %','baytri5',1,TRUE,0.95,3,FALSE,1),
(12,'Baytril Injectable 10 %','baytri10',1,TRUE,1.67,3,FALSE,1),
(13,'Betamox Injectable','betamoxi',1,TRUE,0.20,3,FALSE,1),
(14,'Betamox Injectable 50 ml','betamoxib',1,TRUE,9.70,9,TRUE,2),
(15,'Buster Collar 25 cm','collar25',6,FALSE,10.21,12,FALSE,1),
(16,'Choo-Bone XL','choobonexl',7,FALSE,1.28,12,FALSE,2),
(17,'Dexafort Injection','dexaf',1,TRUE,0.41,3,FALSE,1),
(18,'Drontal Plus Palatable Canine','drontppc',1,FALSE,1.19,1,TRUE,2),
(19,'Duramune DAPPi+L','ddappil',1,TRUE,6.81,13,FALSE,2),
(20,'Duramune DAPPi+LC','ddappilc',1,TRUE,8.17,13,FALSE,2),
(21,'Eurican DHPPi+LC','edhppilc',1,TRUE,8.51,13,FALSE,2),
(22,'Felimazole 2.5 mg','felimaz2.5',1,TRUE,1.50,1,TRUE,2),
(23,'Fevaxyn Pentofel','fpento',1,TRUE,8.51,13,FALSE,2),
(24,'Fevaxyn iCHPChlam','fichpch',1,TRUE,6.81,13,FALSE,2),
(25,'Frontline Spray 100 ml','frontl100',1,FALSE,7.23,9,TRUE,2),
(26,'Frontline Spray 250 ml','frontl250',1,FALSE,13.62,9,TRUE,2),
(27,'Hills Feline Growth 1.8 kg','hfgr1.8',7,FALSE,5.96,10,TRUE,2),
(28,'Marbocyl Injectable 2.5 %','marboi2.5',1,TRUE,0.27,3,FALSE,1),
(29,'Nobivac KC','nkc',1,TRUE,13.62,13,FALSE,2),
(30,'Nobivac Myxo','nmyxo',1,TRUE,4.26,13,FALSE,2),
(31,'Nobivac Rabies','nrab',1,TRUE,12.77,13,FALSE,2),
(32,'Oral Hygiene Rinse','oralhy',1,FALSE,4.26,9,TRUE,1),
(33,'ProteqFlu','proteqf',1,TRUE,7.66,13,FALSE,2),
(34,'ProteqFlu Te','proteqft',1,TRUE,10.21,13,FALSE,2),
(35,'Vicryl 5-0 mounted','vicryl50m',1,TRUE,2.98,12,FALSE,1),
(36,'VitBee 1000 Injectable','vitbee1k',1,TRUE,0.48,3,FALSE,1),
(37,'Consultation','constd',4,FALSE,20.00,15,FALSE,1),
(38,'Consultation Follow-Up','con2',4,FALSE,14.89,15,FALSE,1),
(39,'Consultation Further Follow-Up','conff',4,FALSE,9.79,15,FALSE,1),
(40,'Consultation Free','confree',4,FALSE,0.00,15,FALSE,1),
(41,'Consultation Child Pet','conchpet',4,FALSE,6.38,15,FALSE,1),
(42,'Consultation Exotic','conexot',4,FALSE,23.40,15,FALSE,1),
(43,'Consultation Out of Hours 1 ( 7 pm to 10 pm)','conooh1',4,FALSE,28.51,15,FALSE,1),
(44,'Consultation Out of Hours 2 (10 pm to  0 am)','conooh2',4,FALSE,37.87,15,FALSE,1),
(45,'Consultation Out of Hours 3 ( 0 am to  7 am)','conooh3',4,FALSE,47.23,15,FALSE,1),
(46,'Consultation Out of Hours 4 (Sat 5 pm to Mon 7 am)','conooh4',4,FALSE,56.68,15,FALSE,1),
(47,'Castr. Canine S (< 10 kg)','castc1',3,FALSE,34.04,15,FALSE,1),
(48,'Castr. Canine M (< 20 kg)','castc2',3,FALSE,51.06,15,FALSE,1),
(49,'Castr. Canine L (< 50 kg)','castc3',3,FALSE,68.09,15,FALSE,1),
(50,'Castr. Canine XL (<100 kg)','castc4',3,FALSE,85.11,15,FALSE,1),
(51,'Castr. Canine XXL (>100 kg)','castc5',3,FALSE,119.15,15,FALSE,1),
(52,'Castr. Feline','castf',3,FALSE,25.53,15,FALSE,1),
(53,'Castr. Lagomorph/Rodent','castr',3,FALSE,35.74,15,FALSE,1),
(54,'Spay Canine S   (< 10 kg)','spaycs',3,FALSE,51.06,15,FALSE,1),
(55,'Spay Canine M   (< 20 kg)','spaycm',3,FALSE,68.09,15,FALSE,1),
(56,'Spay Canine L   (< 50 kg)','spaycl',3,FALSE,85.11,15,FALSE,1),
(57,'Spay Canine XL  (<100 kg)','spaycxl',3,FALSE,119.15,15,FALSE,1),
(58,'Spay Canine XXL (>100 kg)','spaycxxl',3,FALSE,153.19,15,FALSE,1),
(59,'Spay Feline','spayf1',3,FALSE,42.55,15,FALSE,1),
(60,'Spay Feline Pregnant','spayf2',3,FALSE,51.06,15,FALSE,1),
(61,'Spay Feline Season','spayf3',3,FALSE,68.09,15,FALSE,1),
(62,'Spay Rabbit/Rodent','spayr',3,FALSE,25.53,15,FALSE,1),
(63,'Euthanasia Canine S   (< 10 kg)','euthcs',3,FALSE,29.79,15,FALSE,1),
(64,'Euthanasia Canine M   (< 20 kg)','euthcm',3,FALSE,38.30,15,FALSE,1),
(65,'Euthanasia Canine L   (< 50 kg)','euthcl',3,FALSE,55.32,15,FALSE,1),
(66,'Euthanasia Canine XL  (<100 kg)','euthcxl',3,FALSE,72.34,15,FALSE,1),
(67,'Euthanasia Canine XXL (>100 kg)','euthcxxl',3,FALSE,89.36,15,FALSE,1),
(68,'Euthanasia Feline','euthf',3,FALSE,25.53,15,FALSE,1),
(69,'Euth./Body Disposal Canine S   (< 10 kg)','euthcsb',3,FALSE,4.26,15,FALSE,1),
(70,'Euth./Body Disposal Canine M   (< 20 kg)','euthcmb',3,FALSE,8.52,15,FALSE,1),
(71,'Euth./Body Disposal Canine L   (< 50 kg)','euthclb',3,FALSE,12.78,15,FALSE,1),
(72,'Euth./Body Disposal Canine XL  (<100 kg)','euthcxlb',3,FALSE,17.04,15,FALSE,1),
(73,'Euth./Body Disposal Canine XXL (>100 kg)','euthcxxlb',3,FALSE,25.60,15,FALSE,1),
(74,'Euth./Body Disposal Feline','euthfb',3,FALSE,4.26,15,FALSE,1),
(75,'Euth./Individual Cremation','euthind',3,FALSE,0.00,15,FALSE,1),
(76,'Injection s.c.','injsc',3,FALSE,1.91,15,FALSE,1),
(77,'Injection i.m.','injim',3,FALSE,2.77,15,FALSE,1),
(78,'Injection i.v.','injiv',3,FALSE,6.17,15,FALSE,1),
(79,'Injection i.a.','injia',3,FALSE,13.40,15,FALSE,1),
(80,'Injection i.v. Catheter','injivc',3,FALSE,8.51,15,FALSE,1),
(81,'Anal Gland Emptying during Consultation','ag1',3,FALSE,6.81,15,FALSE,1),
(82,'Anal Gland Emptying (only)','ag2',3,FALSE,10.64,15,FALSE,1),
(83,'Tablet Administration','tab1',3,FALSE,0.85,15,FALSE,1),
(84,'Tablet Administration difficult','tab2',3,FALSE,2.55,15,FALSE,1),
(85,'Dispense Fee','disp',3,FALSE,0.85,15,FALSE,1),
(86,'Dispense Fee Out of Hours 1 ( 7 pm to 10 pm)','dispo1',3,FALSE,2.13,15,FALSE,1),
(87,'Dispense Fee Out of Hours 2 (10 pm to  0 am)','dispo2',3,FALSE,4.26,15,FALSE,1),
(88,'Dispense Fee Out of Hours 3 ( 0 am to  7 am)','dispo3',3,FALSE,6.38,15,FALSE,1),
(89,'Dispense Fee Out of Hours 4 (Sat 5 pm to Non 7 am)','dispo4',3,FALSE,8.52,15,FALSE,1),
(90,'Dressing S','dress',3,FALSE,2.13,15,FALSE,1),
(91,'Dressing M','dresm',3,FALSE,4.26,15,FALSE,1),
(92,'Dressing L','dresl',3,FALSE,8.52,15,FALSE,1),
(93,'Clip nails','clipn',3,FALSE,4.26,15,FALSE,1),
(94,'Clip nails (only)','clipno',3,FALSE,8.52,15,FALSE,1),
(95,'Clip beak and nails','clipbn',3,FALSE,11.91,15,FALSE,1),
(96,'Ear cleaning','ears',3,FALSE,8.26,15,FALSE,1),
(97,'Dental Scaling and Polishing Feline incl. Anaesth.','dentf',3,FALSE,68.09,15,FALSE,1),
(98,'Dental Scaling and Polishing Canine S   (< 10 kg)','dentcs',3,FALSE,68.09,15,FALSE,1),
(99,'Dental Scaling and Polishing Canine M   (< 20 kg)','dentcm',3,FALSE,85.11,15,FALSE,1),
(100,'Dental Scaling and Polishing Canine L   (< 50 kg)','dentcl',3,FALSE,102.13,15,FALSE,1),
(101,'Dental Scaling and Polishing Canine XL  (<100 kg)','dentcxl',3,FALSE,119.15,15,FALSE,1),
(102,'Dental Scaling and Polishing Canine XXL (>100 kg)','dentcxxl',3,FALSE,136.17,15,FALSE,1),
(103,'Dental Extraction','dentx',3,FALSE,4.26,15,FALSE,1),
(104,'Dental Extraction Complicated','dentxc',3,FALSE,11.91,15,FALSE,1),
(105,'Grooming per 10 min','groom',3,FALSE,4.68,15,FALSE,1),
(106,'General Anaesthesia Feline per 10 min','anesf',3,FALSE,8.52,15,FALSE,1),
(107,'General Anaesthesia Canine < 10 kg per 10 min','anesc1',3,FALSE,8.52,15,FALSE,1),
(108,'Surgical Time per 10 min','surgt1',3,FALSE,25.53,15,FALSE,1),
(109,'Professional Time per 10 min','proft1',3,FALSE,17.02,15,FALSE,1),
(110,'Ultrasound Scan Time per 10 min','uss1',3,FALSE,34.04,15,FALSE,1),
(111,'Urinalysis Dip-Stick','ur1',3,FALSE,4.26,15,FALSE,1),
(112,'Urinalysis microscopic crystals','ur2',3,FALSE,6.81,15,FALSE,1),
(113,'Urinalysis microscopic cytology','ur3',3,FALSE,12.77,15,FALSE,1),
(114,'Visit within 20 miles','visit1',3,FALSE,34.04,15,FALSE,1),
(115,'Visit per extra mile','visit2',3,FALSE,0.68,15,FALSE,1),
(116,'Xray 1st Plate','xray1',3,FALSE,29.79,15,FALSE,1),
(117,'Xray 2nd Plate','xray2',3,FALSE,21.28,15,FALSE,1),
(118,'Xray 3rd Plate','xray3',3,FALSE,12.77,15,FALSE,1),
(119,'Xray Same Plate 1 more Exposure','xray4',3,FALSE,4.26,15,FALSE,1),
(120,'Tel. advice per 10 min','tel1',3,FALSE,12.77,15,FALSE,1),
(121,'Hospitalisation Feline per night','hosf',3,FALSE,4.26,15,FALSE,1),
(122,'Hospitalisation Canine S   (< 10 kg) per night','hoscs',3,FALSE,4.26,15,FALSE,1),
(123,'Hospitalisation Canine M   (< 20 kg) per night','hoscm',3,FALSE,6.81,15,FALSE,1),
(124,'Hospitalisation Canine L   (< 50 kg) per night','hoscl',3,FALSE,10.21,15,FALSE,1),
(125,'Hospitalisation Canine XL  (<100 kg) per night','hoscxl',3,FALSE,12.77,15,FALSE,1),
(126,'Hospitalisation Canine XXL (>100 kg) per night','hoscxxl',3,FALSE,17.02,15,FALSE,1),
(127,'Repeat Prescription','reppre',3,FALSE,4.26,15,FALSE,1),
(128,'Died naturally','diednat',2,FALSE,0.00,15,FALSE,null),
(129,'Dead On Arrival','doa',2,FALSE,0.00,15,FALSE,null),
(130,'Vacc. Canine DHPPi+L2 1st incl. 2nd','vacc61','vac',TRUE,34.04,13,FALSE,1),
(131,'Vacc. Canine DHPPi+L2 2nd','vacc62','vac',TRUE,0.00,13,FALSE,1),
(132,'Vacc. Canine DHPPi+L2 2nd only','vacc621','vac',TRUE,20.43,13,FALSE,1),
(133,'Vacc. Canine DHPPi+L2 Booster','vacc6b','vac',TRUE,25.53,13,FALSE,1),
(134,'Vacc. Canine DHPPi 1st incl. 2nd','vacc41','vac',TRUE,29.79,13,FALSE,1),
(135,'Vacc. Canine DHPPi 2nd','vacc42','vac',TRUE,0.00,13,FALSE,1),
(136,'Vacc. Canine DHPPi 2nd only','vacc421','vac',TRUE,15.32,13,FALSE,1),
(137,'Vacc. Canine DHPPi Booster','vacc4b','vac',TRUE,23.83,13,FALSE,1),
(138,'Vacc. Canine Kennel Cough','vacckc','vac',TRUE,17.02,13,FALSE,1),
(139,'Vacc. Canine Kennel Cough + other','vacckc2','vac',TRUE,12.77,13,FALSE,1),
(140,'Vacc. Rabies','vacrab','vac',TRUE,25.53,13,FALSE,1),
(141,'Vacc. Feline4 + FeLV 1st incl. 2nd','vacf51','vac',TRUE,34.04,13,FALSE,1),
(142,'Vacc. Feline4 + FeLV 2nd','vacf52','vac',TRUE,0.00,13,FALSE,1),
(143,'Vacc. Feline4 + FeLV 2nd only','vacf521','vac',TRUE,21.28,13,FALSE,1),
(144,'Vacc. Feline4 + FeLV Booster','vacf5b','vac',TRUE,25.53,13,FALSE,1),
(145,'Vacc. Feline4 2nd','vacf42','vac',TRUE,0.00,13,FALSE,1),
(146,'Vacc. Feline4 2nd only','vacf421','vac',TRUE,25.53,13,FALSE,1),
(147,'Vacc. Feline4 Booster','vacf4b','vac',TRUE,21.28,13,FALSE,1),
(148,'Vacc. Equine Flu 1st incl. 2nd','vacef1','vac',TRUE,46.81,13,FALSE,1),
(149,'Vacc. Equine Flu 1st only','vacef11','vac',TRUE,25.53,13,FALSE,1),
(150,'Vacc. Equine Flu 2nd','vacef2','vac',TRUE,0.00,13,FALSE,1),
(151,'Vacc. Equine Flu 2nd only','vacef21','vac',TRUE,25.53,13,FALSE,1),
(152,'Vacc. Equine Flu Booster','vacefb','vac',TRUE,25.53,13,FALSE,1),
(153,'Vacc. Equine Tet 1st','vacet1','vac',TRUE,21.28,13,FALSE,1),
(154,'Vacc. Equine Tet Booster','vacetb','vac',TRUE,21.28,13,FALSE,1),
(155,'Vacc. Equine FT 1st incl. 2nd','vaceft1','vac',TRUE,59.57,13,FALSE,1),
(156,'Vacc. Equine FT 1st only','vaceft11','vac',TRUE,34.04,13,FALSE,1),
(157,'Vacc. Equine FT 2nd','vaceft2','vac',TRUE,0.00,13,FALSE,1),
(158,'Vacc. Equine FT Booster','vaceftb','vac',TRUE,21.28,13,FALSE,1),
(159,'Vacc. Equine EHV 1st','vaceh1','vac',TRUE,25.53,13,FALSE,1),
(160,'Vacc. Equine EHV Booster','vacehb','vac',TRUE,25.53,13,FALSE,1),
(161,'Vacc. Rabbit Myxo','vaclmyxo','vac',TRUE,12.77,13,FALSE,1),
(162,'Vacc. Rabbit VHD','vaclvhd','vac',TRUE,12.77,13,FALSE,1),
(163,'Vacc. Canine Parvo','vaccp1','vac',TRUE,10.21,13,FALSE,1),
(164,'Vacc. Tetanol','tet',1,TRUE,10.21,13,FALSE,1),
(165,'Vacc. Prevacun FT','prevacft',1,TRUE,10.21,13,FALSE,1),
(166,'Vacc. EHV1','ehv',1,TRUE,17.02,13,FALSE,1),
(167,'Vacc. Cylap','cylap',1,TRUE,8.52,13,FALSE,1),
(168,'Vacc. Nobivac Puppy P','nobipupp',1,TRUE,10.21,13,FALSE,1),
(169,'Onsior Tablets 80 mg','onsior80',1,TRUE,1.19,1,TRUE,2),
(170,'Vacc. Feline4 1st incl 2nd','vacf41','vac',TRUE,25,13,FALSE,1),
(171,'Drop Administration','drop',3,FALSE,0.85,15,FALSE,1);
